...
for filename in listdir(curdir):
    if filename.lower().endswith('.lock'):
            ...
            for line in fp:
                if line.strip():
                    ...
                    if line.strip() == "[[package]]":
                        ...
                        dependency_to_add.name = dependency_string[0]
                        dependency_to_add.version = dependency_string[1]
                        ...
                        # for substr in re.findall(r'"(.*?)"', line)[0].split(' '):
                        #     print(substr)
