# Cargo TOML File Version Dependency Parser
#
# This script parses a cargo.toml file and finds the versions of all dependencies
# so that they can be updated.

import re


# Method to parse the passed file (a Cargo.toml file)
def toml_file_parse(fname, lock_file):
